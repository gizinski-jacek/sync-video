	...
	return (
		<div className={`${styles.playlist} ${showPlaylist ? styles.visible : ''}`}>
			<div className={styles.controls}>
				<button
					className='flex-1 bg-red-700 hover:bg-red-600 rounded py-1 px-2 transition-all cursor-pointer font-bold uppercase'
					onClick={clearPlaylist}
				>
					Clear All
				</button>
				<button
					className='flex-1 bg-yellow-600 hover:bg-yellow-500 rounded py-1 px-2 transition-all cursor-pointer text-slate-900 font-bold uppercase'
